...
<head>
    ...
    <title>Premium Ice Cream - Luxury Experience</title>
    ...
    <section class="hero" id="home">
        <div class="hero-container">
            <div class="hero-content">
                ...
                <h1 class="hero-title">LUXURY<br>FLAVORS</h1>
                <p class="hero-subtitle">Experience the finest artisan ice cream crafted with premium ingredients and innovative techniques. Each scoop is a journey through extraordinary taste.</p>
                <a href="index.php" class="hero-cta">Explore Collection</a>
            ...
            <div class="hero-image">
                <img src="images/pistachio.webp" alt="Premium Ice Cream" onerror="this.src='https://images.unsplash.com/photo-1563805042-7684c019e1cb?w=500&h=400&fit=crop'">
            </div>
        </div>
    </section>
</body>
